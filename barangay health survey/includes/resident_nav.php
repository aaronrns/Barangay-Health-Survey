<?php
// Shared resident sidebar. Include this from every resident page instead of
// writing the navbar markup by hand, so residents get the same rich sidebar
// layout used on the staff side (see includes/staff_nav.php).
...
<div class="sidebar">
    ...
    <nav class="sidebar-links">
        ...
        <a class="<?= trim(nav_active("profile.php", $current_page)) ?>" href="profile.php" title="My Profile">
            <span class="ic"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg></span>
    ...
    <div class="sidebar-footer">
        ...
        <span class="label">Your voice shapes our<br>community's health.</span>
    </div>
</div>